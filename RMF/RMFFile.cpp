...
// Output  : 
//////////////////////////////////////////////////////////////////////
void CRMFFile::GetWadfiles(WadList* wadlist)
{
}
...
// Output  : 
//////////////////////////////////////////////////////////////////////
CRMFEntity* CRMFFile::GetWorldSpawn()
{
	return &this->FileWorldspawn;
}
...
{
	float ambience[4] = {0.5f, 0.5f, 0.5f, 0.1f};		// The color of the light in the world
	float diffuse[4] = {0.01f, 0.01f, 0.01f, 0.1f};		// The color of the positioned light
	float position[4] = {-4000, 0, 0, 1.0f};
